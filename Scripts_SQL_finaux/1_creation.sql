------------------------------------------------------------
-- Fichier     : 1_creation
-- Date        : 15/02/2014 (integration 27/03/2014) 
-- Version     : 1.1
...
BEGIN TRY
	CREATE ASSEMBLY RegExFunc FROM 'C:\Users\boris\Documents\IBDR\Repository\Scripts_SQL_finaux\Ressources\SQLServerCLR.dll';
