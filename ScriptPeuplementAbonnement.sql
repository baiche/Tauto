...
VALUES
	...
	('2013-05-01', 90, 0, 'bronze',      'TASociety',  'TASociety',  '1980-02-24'), -- id = 2
	('2013-11-01', 30, 0, 'or',          'PIndustrie', 'PIndustrie', '1980-02-17'), -- id = 3
	...
	('2014-02-01', 60, 0, 'or',          'PIndustrie', 'PIndustrie', '1980-02-17'), -- id = 8
	('2014-02-07', 30, 1, '1vehicules',  'Mottier',    'Allan',      '1989-03-23'), -- id = 9
	('2014-02-15', 30, 1, 'argent',      'TASociety',  'TASociety',  '1980-02-24'), -- id = 10
