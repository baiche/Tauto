...
-- Testeur     : 
-- Integrateur : 
-- Commentaire : Met fin à un contrat de location si ce dernier existe. Renvoie 1 en cas de succès, -1 autrement
------------------------------------------------------------
...
BEGIN
	...
	ELSE
	BEGIN
		PRINT('ContratLocation: ERROR, impossible à terminer car pas trouvé');
		RETURN -1;
	END
END
GO